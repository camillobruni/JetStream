...
/*ThouShaltNotCache*/
defineProperty(object,propName,{enumerable:!1,writable:!0,configurable:!0,value})}function addHiddenFinalProp(object,propName,value){
/*ThouShaltNotCache*/
defineProperty(object,propName,{enumerable:!1,writable:!1,configurable:!0,value})}function createInstanceofPredicate(name,theClass){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
return isObservable(v)?v:Array.isArray(v)?observable.array(v,{name}):isPlainObject(v)?observable.object(v,void 0,{name}):isES6Map(v)?observable.map(v,{name}):isES6Set(v)?observable.set(v,{name}):"function"!=typeof v||isAction(v)||isFlow(v)?v:isGenerator(v)?flow(v):autoAction(name,v)}function referenceEnhancer(newValue){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
void 0===safeDescriptors&&(safeDescriptors=globalState.safeDescriptors),_ref2=descriptor,annotation.annotationType_,_ref2.value;var _adm$proxy_,value=descriptor.value;(isFlow(value)||(value=flow(value)),bound)&&((value=value.bind(null!=(_adm$proxy_=adm.proxy_)?_adm$proxy_:adm.target_)).isMobXFlow=!0);return{value,configurable:!safeDescriptors||adm.isPlainObject_,enumerable:!1,writable:!safeDescriptors}}function createComputedAnnotation(name,options){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
var adm=asObservableObject(this)[$mobx],options=_extends({},ann.options_,{get,context:this});options.name||(options.name="ObservableObject."+key.toString()),adm.values_.set(key,new ComputedValue(options))}),function(){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
var _this$options_3,_this$options_4,_this$options_2,_this$options_;if(descriptor.get)return computed.make_(adm,key,descriptor,source);if(descriptor.set){var set=createAction(key.toString(),descriptor.set);return source===adm.target_?null===adm.defineProperty_(key,{configurable:!globalState.safeDescriptors||adm.isPlainObject_,set})?0:2:(defineProperty(source,key,{configurable:!0,set}),2)}if(source!==adm.target_&&"function"==typeof descriptor.value)return isGenerator(descriptor.value)?(null!=(_this$options_=this.options_)&&_this$options_.autoBind?flow.bound:flow).make_(adm,key,descriptor,source):(null!=(_this$options_2=this.options_)&&_this$options_2.autoBind?autoAction.bound:autoAction).make_(adm,key,descriptor,source);var _adm$proxy_,observableAnnotation=!1===(null==(_this$options_3=this.options_)?void 0:_this$options_3.deep)?observable.ref:observable;"function"==typeof descriptor.value&&null!=(_this$options_4=this.options_)&&_this$options_4.autoBind&&(descriptor.value=descriptor.value.bind(null!=(_adm$proxy_=adm.proxy_)?_adm$proxy_:adm.target_));return observableAnnotation.make_(adm,key,descriptor,source)}function extend_$5(adm,key,descriptor,proxyTrap){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
return null==v||isObservableObject(v)||isObservableArray(v)||isObservableMap(v)||isObservableSet(v)?v:Array.isArray(v)?observable.array(v,{name,deep:!1}):isPlainObject(v)?observable.object(v,void 0,{name,deep:!1}):isES6Map(v)?observable.map(v,{name,deep:!1}):isES6Set(v)?observable.set(v,{name,deep:!1}):void 0}}),observableStructAnnotation=createObservableAnnotation("observable.struct",{enhancer:function(v,oldValue){return deepEqual(v,oldValue)?oldValue:v}}),observableDecoratorAnnotation=createDecoratorAnnotation(observableAnnotation);function getEnhancerFromOptions(options){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
var notifySpy_=!1,startTime_=0;0;var prevDerivation_=globalState.trackingDerivation,runAsAction=!canRunAsDerivation||!prevDerivation_;startBatch();var prevAllowStateChanges_=globalState.allowStateChanges;runAsAction&&(untrackedStart(),prevAllowStateChanges_=allowStateChangesStart(!0));var prevAllowStateReads_=allowStateReadsStart(!0),runInfo={runAsAction_:runAsAction,prevDerivation_,prevAllowStateChanges_,prevAllowStateReads_,notifySpy_,startTime_,actionId_:nextActionId++,parentActionId_:currentActionId};return currentActionId=runInfo.actionId_,runInfo}(0,canRunAsDerivation);try{return fn.apply(scope,args)}catch(err){throw runInfo.error_=err,err}finally{!function(runInfo){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
checkIfStateModificationsAreAllowed(this),hasInterceptors(this)){var change=interceptChange(this,{object:this,type:UPDATE,newValue});if(!change)return globalState.UNCHANGED;newValue=change.newValue}return newValue=this.enhancer(newValue,this.value_,this.name_),this.equals(this.value_,newValue)?globalState.UNCHANGED:newValue},_proto.setNewValue_=function(newValue){
/*ThouShaltNotCache*/
var oldValue=this.value_;this.value_=newValue,this.reportChanged(),hasListeners(this)&&notifyListeners(this,{type:UPDATE,object:this,newValue,oldValue})},_proto.get=function(){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
var _this=this;this.atom_;var length=this.values_.length;if(void 0===index?index=0:index>length?index=length:index<0&&(index=Math.max(0,length+index)),deleteCount=1===arguments.length?length-index:null==deleteCount?0:Math.max(0,Math.min(deleteCount,length-index)),void 0===newItems&&(newItems=EMPTY_ARRAY),hasInterceptors(this)){var change=interceptChange(this,{object:this.proxy_,type:"splice",index,removedCount:deleteCount,added:newItems});if(!change)return EMPTY_ARRAY;deleteCount=change.removedCount,newItems=change.added}if(newItems=0===newItems.length?newItems:newItems.map(function(v){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
var notifySpy=!this.owned_&&!1,notify=hasListeners(this),change=notify||notifySpy?{observableKind:"array",object:this.proxy_,type:UPDATE,debugObjectName:this.atom_.name_,index,newValue,oldValue}:null;this.atom_.reportChanged(),notify&&notifyListeners(this,change)},_proto.notifyArraySplice_=function(index,added,removed){
/*ThouShaltNotCache*/
var notifySpy=!this.owned_&&!1,notify=hasListeners(this),change=notify||notifySpy?{observableKind:"array",object:this.proxy_,debugObjectName:this.atom_.name_,type:"splice",index,removed,added,removedCount:removed.length,addedCount:added.length}:null;this.atom_.reportChanged(),notify&&notifyListeners(this,change)},_proto.get_=function(index){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
var observable=this.data_.get(key);if((newValue=observable.prepareNewValue_(newValue))!==globalState.UNCHANGED){var notify=hasListeners(this),change=notify?{observableKind:"map",debugObjectName:this.name_,type:UPDATE,object:this,oldValue:observable.value_,name:key,newValue}:null;0,observable.setNewValue_(newValue),notify&&notifyListeners(this,change)}},_proto.addValue_=function(key,newValue){
/*ThouShaltNotCache*/
var _this4=this;this.keysAtom_,transaction(function(){
/*ThouShaltNotCache*/
var _this4$hasMap_$get,observable=new ObservableValue(newValue,_this4.enhancer_,"ObservableMap.key",!1);_this4.data_.set(key,observable),newValue=observable.value_,null==(_this4$hasMap_$get=_this4.hasMap_.get(key))||_this4$hasMap_$get.setNewValue_(!0),_this4.keysAtom_.reportChanged()});var notify=hasListeners(this),change=notify?{observableKind:"map",debugObjectName:this.name_,type:ADD,object:this,name:key,newValue}:null;notify&&notifyListeners(this,change)},_proto.get=function(key){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
var _keys$next=keys.next(),done=_keys$next.done,value=_keys$next.value;return{done,value:done?void 0:self.get(value)}}})},_proto.entries=function(){
/*ThouShaltNotCache*/
var self=this,keys=this.keys();return makeIterableForMap({next:function(){
/*ThouShaltNotCache*/
var _keys$next2=keys.next(),done=_keys$next2.done,value=_keys$next2.value;return{done,value:done?void 0:[value,self.get(value)]}}})},_proto[Symbol.iterator]=function(){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
var _values$next=values.next(),value=_values$next.value,done=_values$next.done;return done?{value:void 0,done}:{value:[value,value],done}}})},_proto.keys=function(){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
var _values$next2=values.next(),value=_values$next2.value,done=_values$next2.done;return done?{value:void 0,done}:{value:self.dehanceValue_(value),done}}})},_proto.intersection=function(otherSet){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
return void 0===proxyTrap&&(proxyTrap=!1),hasProp(this.target_,key)?this.values_.has(key)?this.setObservablePropValue_(key,value):proxyTrap?Reflect.set(this.target_,key,value):(this.target_[key]=value,!0):this.extend_(key,{value,enumerable:!0,writable:!0,configurable:!0},this.defaultAnnotation_,proxyTrap)},_proto.has_=function(key){
/*ThouShaltNotCache*/
...
/*ThouShaltNotCache*/
return this}["Symbol","Map","Set"].forEach(function(m){void 0===getGlobal()[m]&&die("MobX requires global '"+m+"' to be available or polyfilled")}),"object"==typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__&&__MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({spy:function(listener){return console.warn("[mobx.spy] Is a no-op in production builds"),function(){}},extras:{getDebugName},$mobx});class Person{id;name;lastMessage=null;rooms=new Set;status="Online";constructor(id,name){
/*ThouShaltNotCache*/
